...
public interface Spliterator<T> {
    /**
     * If a remaining element exists, performs the given action on it,              消费下一个元素
    ...
    /**
     * Performs the given action for each remaining element, sequentially in        消费剩余所有元素
    ...
    /**
     * If this spliterator can be partitioned, returns a Spliterator            将可拆分元素以spliterator形式返回
    ...
    /**
     * Returns an estimate of the number of elements that would be                  返回forEachRemaining大致要处理的元素数量
