        ...
        implements java.io.Serializable, Cloneable, Comparable<Date>
{
    ...
    private transient long fastTime;        // 存储的是　System.currentTimeMillis()

    /**
     * If cdate is null, then fastTime indicates the time in millis.
     * If cdate.isNormalized() is true, then fastTime and cdate are in          受时区影响的
     * synch. Otherwise, fastTime is ignored, and cdate indicates the           标准化之后cdate与fastTime保持同步
     * time.
     */
     ...
     * <li><tt>zzz</tt> is the time zone (and may reflect daylight saving       显示的时区，可能会由于夏令时被调整到临近的时区
    ...
    public String toString() {
        ...
        BaseCalendar.Date date = normalize();               // 标准化并获取到时区影响的时间
