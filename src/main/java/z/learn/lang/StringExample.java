 ...
 * Constant pool:                            // 常量表
 * #1 = Methodref          #14.#32        // java/lang/Object."<init>":()V           要查找两个  #14 和 #32
 ...
 * 0: aload_0                          // 将局部变量表LocalVariableTable 变量0 加载到栈顶
 ...
 * descriptor: ()V
 * flags: ACC_PUBLIC
 * Code:                               stack=4表示操作数栈的最大深度为4？locals局部变量有6个，实例方法加上this变量。args_size表示方法入参1个，this变量。
 ...
 * line 17: 96
 * line 18: 104
 * LocalVariableTable:                    ！！！局部变量表   存储在栈  JVM是一个基于栈的架构。方法执行的时候（包括main方法），在栈上会分配一个新的帧，这个栈帧包含一组局部变量。
 * Start  Length  Slot  Name   Signature
